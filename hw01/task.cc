...
int main() {
    ...
    std::count_if(freq1.begin(), freq1.end(), [&](const std::pair<char,int>& p){
    ...
    std::count_if(text2.begin(), text2.end(), [&](char ch){
    ...
    int sm = 0;
    std::count_if(freq2.begin(), freq2.end(), [&](const std::pair<char,int>& p){
